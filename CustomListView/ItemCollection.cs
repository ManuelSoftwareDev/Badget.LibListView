...
namespace Badget.LibListview.Controls
{
	...
	TypeConverter("Badget.LibListview.Controls.GLSubItemConverter")
	]
	public class GLSubItem
	{
		...
		private BadgetListView			m_Parent = null;							// so we can always access the columns
	...
	public class GLSubItemCollection : CollectionBase
	{
		...
		public GLSubItemCollection( BadgetListView parent )
		{
			m_Parent = parent;
		}
		...
		{	// this gets called when an item internally changes
			BadgetListView.DW("GLSubItemCollection::SubItem_Changed");
		...
		private BadgetListView				m_Parent;
	...
	[
	DesignTimeVisible(true),
	TypeConverter("Badget.LibListview.Controls.GLItemConverter")
	]
	public class GLItem								// : IComparable
	{
		...
		{	// this gets called when an item internally changes
			BadgetListView.DW("GLItem::SubItemCollection_Changed");
		...
		/// </summary>
		/// <param name="parent"></param>
		public GLItem( BadgetListView parent )
		{
		...
		private object										m_Tag = null;
		private Color										m_ForeColor = Color.Black;
		private BadgetListView								m_Parent = null;
	...
	public class GLItemCollection : CollectionBase
	{
		...
		{	// this gets called when an item internally changes
			BadgetListView.DW("GLItemCollection::Item_Changed");
		...
		public GLItemCollection( BadgetListView newParent )
		{
			Parent = newParent;
		}
