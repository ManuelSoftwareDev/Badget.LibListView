...
namespace Badget.LibListview.Controls
{
	...
	TypeConverter("Badget.LibListview.Controls.GLColumnConverter")
	]
	...
	public class GLColumnCollection : CollectionBase
	{
		...
		public GLColumnCollection( BadgetListView parent )
		{
			this.Parent = parent;
		}
	...
	internal class CustomCollectionEditor : CollectionEditor
	{
		...
		{
			BadgetListView originalControl = (BadgetListView)context.Instance;
