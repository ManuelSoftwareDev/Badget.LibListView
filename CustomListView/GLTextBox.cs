...
namespace Badget.LibListview.Controls
{
	...
	internal class GLTextBox : System.Windows.Forms.TextBox, GLEmbeddedControl
	{
		...
		public BadgetListView	 ListControl
		{ 
			get
			{
				return m_Parent;
		...
		protected BadgetListView m_Parent = null;

		public bool GLLoad( GLItem item, GLSubItem subItem, BadgetListView listctrl )				// populate this control however you wish with item
		{
